...
public sealed record SemicolonJoinedStringTests
{
    [Fact]
    public void JoinCorrectly()
    {
        ...
        IString str = new SemicolonJoinedString(
    ...
    {
        const string a = "Hello";
        IString str = new SemicolonJoinedString([new String(a)]);
    ...
    public void EnumeratesAsUntyped()
    {
        ...
        IEnumerable str = new SemicolonJoinedString(
            [new String(a), new String(b), new String(c)]
        );
    ...
    public void ThrowsExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new SemicolonJoinedString([]).GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new SemicolonJoinedString([]).ToString()
        );
    }
}
