...
public sealed record ColonSeparatedStringTests
{
    ...
    public void JoinCorrectly()
    {
        ...
        IString str = new ColonJoinedString(
    ...
    {
        const string a = "Hello";
        IString str = new ColonJoinedString([new String(a)]);
    ...
    public void EnumeratesAsUntyped()
    {
        ...
        IEnumerable str = new ColonJoinedString(
            [new String(a), new String(b), new String(c)]
        );
    ...
    public void ThrowsExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new ColonJoinedString([]).GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new ColonJoinedString([]).ToString()
        );
    }
}
